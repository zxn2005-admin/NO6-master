				...
				<el-row >
					...
					<el-col :span="24">
						<el-form-item label="医生简介" prop="yishengjianjie">
							<editor :value="form.yishengjianjie" placeholder="请输入医生简介" :readonly="!isAdd||disabledForm.yishengjianjie?true:false"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.yishengjianjie = res.data.data.yishengjianjie?(res.data.data.yishengjianjie.replace(reg,'../../../cl515882190/file')):'';
