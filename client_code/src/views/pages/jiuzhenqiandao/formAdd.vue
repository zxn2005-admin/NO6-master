<template>
	<div class="edit_view" :style='{}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="12">
					<el-form-item label="就诊编号" prop="jiuzhenbianhao">
						<el-input class="list_inp" v-model="form.jiuzhenbianhao" placeholder="请输入就诊编号" readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='jiuzhenbianhao'){
					form.value.jiuzhenbianhao = row[x];
					disabledForm.value.jiuzhenbianhao = true;
					continue;
				}
