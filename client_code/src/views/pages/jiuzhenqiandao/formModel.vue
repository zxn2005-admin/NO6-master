	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">就诊编号</div>
					<div  class="info_text" >{{detail.jiuzhenbianhao}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth('jiuzhenqiandao','诊断')" @click="zhenduanbinglionAcross('诊断','','','','')" type="warning">诊断</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiuzhenqiandao','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiuzhenqiandao','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
	</div>
...
<script setup>
	...
	const zhenduanbinglionAcross = async (btnType,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1) => {
		if(!context?.$toolUtil.storageGet('frontToken')){
			context?.$toolUtil.message('请登录后再操作！','error')
			return false
		}
		if(!btnAuth('jiuzhenqiandao',btnType)){
		...
		nextTick(()=>{
			router.push(`/index/zhenduanbingliAdd?type=cross&&id=${detail.value.id}`)
		})
	}
	onMounted(()=>{
		init()
