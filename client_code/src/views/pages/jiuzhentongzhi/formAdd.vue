			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="通知编号" prop="tongzhibianhao">
						<el-input class="list_inp" v-model="form.tongzhibianhao" placeholder="请输入通知编号" readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
				...
				<el-col :span="12">
					<el-form-item label="通知备注" prop="tongzhibeizhu">
						<el-input class="list_inp" v-model="form.tongzhibeizhu" placeholder="通知备注"
							 type="text" 							:readonly="!isAdd||disabledForm.tongzhibeizhu?true:false" />
					</el-form-item>
				</el-col>
