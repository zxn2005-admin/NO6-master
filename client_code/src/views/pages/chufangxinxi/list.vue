    ...
    <div class="search_view">
        ...
        <div class="search_box">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('chufangxinxi','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="开方数量" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.kaifangshuliang}}
							</template>
						</el-table-column>
						<el-table-column label="服用方法" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.fuyongfangfa}}
							</template>
						</el-table-column>
						<el-table-column label="其他费用" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.qitafeiyong}}
							</template>
						</el-table-column>
						<el-table-column label="需缴金额" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="开方时间" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="其他" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.qita}}
							</template>
						</el-table-column>
						<el-table-column label="是否支付" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								...
								<el-button v-if="scope.row.ispay!='已支付'  && btnAuth('chufangxinxi','支付')" type="text" size="small" @click.stop="payClick(scope.row)">支付</el-button>
							</template>
						</el-table-column>
					</el-table>
                </div>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/chufangxinxiAdd')
	}
	//判断是否从个人中心跳转
